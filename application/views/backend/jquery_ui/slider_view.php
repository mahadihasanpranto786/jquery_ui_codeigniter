            ...
            <div class="col-md-6">
                <div class="card m-2">
                    <label class="pl-2 text-center pb-0" for="range">Price range:
                        <input class="pl-2 " type="text" id="range" readonly
                ...
                <div class="card mt-2">
                    ...
                    <form class="p-3 " method="POST" autocomplete="off" enctype="multipart/data" id="upload_form">
                        <div class="form-group">
                            ...
                            <input type="text" name="sr_name" id="sr_name" class="form-control"
                                placeholder="Name input">
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput">Price</label>
                            <input type="number" name="sr_price" id="sr_price" class="form-control"
