                    ...
                    <div class="card">
                        ...
                        <form class="p-3" method="POST" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="s_text_area1" id="s_text_area1" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Example textarea</label>
                                <textarea class="form-control" name="s_text_area2" id="s_text_area2" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Example textarea</label>
                                <textarea class="form-control" name="s_text_area3" id="s_text_area3" rows="3"></textarea>
                            </div>
                            ...
                            <button type="button" id="REMOVEClass" class="btn float-right btn-warning ">Remove & Add </button>
    ...
    <script>
        $(function() {
            ...
            $("#submitForm").on("click", function() {
                ...
                if ($('#s_text_area1').val() != "" && $('#s_text_area2').val() != "" && $('#s_text_area3').val()) {
                    $.ajax({
                        type: 'POST',
