                ...
                <div id="dialog_1" title="Update Data List">
                    <form>
                        <fieldset>
                            <div class="form-group">
                                <label for="">Dialog Name</label>
                                <input type="text" class="form-control text  ui-widget-content ui-corner-all" name="name" id="d_name_dialog">
                            </div>
                            <div class="form-group">
                                <label for="">Dialog Type</label>
                                <input type="text" class="form-control  text ui-widget-content ui-corner-all" name="address" id="d_address_dialog">
                            </div>
                            <div class="form-group">
                                <label for="">Dialog Descriptions</label>
                                <textarea name="description" id="d_description_dialog" class="textarea  ui-widget-content ui-corner-all text"></textarea>
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="d_id" id="d_id_dialog">
                                <button type="button" id="submitModal" class="ui-button ui-widget ui-corner-all">Update</button>
                            </div>
                        </fieldset>
                    </form>
                </div>
