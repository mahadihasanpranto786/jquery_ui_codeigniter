                ...
                <div class="modal-content">
                    <div class="card">
                        ...
                        <form class="p-3" method="POST">
                            <div class="form-group">
                                <label for="formGroupExampleInput">Name</label>
                                <input type="text" name="s_name" id="s_name_modal" class="form-control" value=""
                                    placeholder="name input">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Address</label>
                                <input type="text" name="s_address" id="s_address_modal" class="form-control"
                                    placeholder="address input">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Email</label>
                                <input type="text" name="s_email" id="s_email_modal" class="form-control"
                                    placeholder="email input">
                            </div>
                            <div class="form-group">
                                <label for="formGroupExampleInput2">Phone</label>
                                <input type="text" name="s_phone" id="s_phone_modal" class="form-control"
                                    placeholder="phone input">
                            </div>
                            <!-- <div class="form-group">
                            <label for="formGroupExampleInput2">Order</label>
...
$(document).ready(function() {
    ...
    $('#submitForm').click(function() {
        if ($('#s_name').val() != "" && $('#s_address').val() != "" && $('#s_email').val() != "" && $(
                '#s_phone').val() != "") {
            $.ajax({
                type: 'POST',
